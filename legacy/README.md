...
notes:
  ...
  - Treat it as a historical and conceptual reference.
  - Prefer the root README, WFGY 2.0 core, and WFGY 3.0 Event Horizon for current use.
-->
...
| ⚙️ Engine | [WFGY 1.0](https://github.com/onestardao/WFGY/blob/main/legacy/README.md) | Original PDF tension engine and early logic sketch — **🔴 YOU ARE HERE 🔴** |
...
- [Problem Map 1.0](https://github.com/onestardao/WFGY/tree/main/ProblemMap/README.md) for the 16 problem RAG checklist and fixes.  
- [Global Debug Card](https://github.com/onestardao/WFGY/blob/main/ProblemMap/wfgy-rag-16-problem-map-global-debug-card.md) for the image based triage protocol.  
- [WFGY Core 2.0](https://github.com/onestardao/WFGY/blob/main/core/README.md) for the current engine layer.
...
1. **Download or open the PDF**
   ...
   - [`WFGY_All_Principles_Return_to_One_v1.0_PSBigBig_Public.pdf`](https://github.com/onestardao/WFGY/blob/main/I_am_not_lizardman/WFGY_All_Principles_Return_to_One_v1.0_PSBigBig_Public.pdf)
...
- [`core/`](https://github.com/onestardao/WFGY/blob/main/core/README.md) for WFGY 2.0,  
- [`ProblemMap/`](https://github.com/onestardao/WFGY/tree/main/ProblemMap) for RAG and system wide debugging,  
- [`TensionUniverse/EventHorizon/`](https://github.com/onestardao/WFGY/blob/main/TensionUniverse/EventHorizon/README.md) for WFGY 3.0.
...
| Layer | Page | What it is for |
| --- | --- | --- |
| Proof | [WFGY Recognition Map](/recognition/README.md) | External citations, integrations, and ecosystem proof |
| Engine | [WFGY 1.0](/legacy/README.md) | Original PDF based tension engine and early logic sketch. Legacy reference only. |
