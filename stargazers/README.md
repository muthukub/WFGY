...
> ⚠️ Note: This list reflects supporters **before WFGY reached 1,000 stars**.  
> It captures the early signal phase of the project — when visibility was low and risk was higher.  
>  
> The split between “Major Legends” and “Rising Legends” is **symbolic only** —  
...
>  
> If you starred WFGY during its early phase and would like to be listed here,  
...
| GitHub ID   | Featured Project(s) / Bio | Proof Screenshot | View stargazer proof |
|-------------|----------------------------|------------------|-----------------------|
| **sienaiwun** | TAA_Unity_URP (493★) · Unity/URP & GPU Rendering dev | ![](./images/sienaiwun_star.png) | [proof](https://github.com/sienaiwun?tab=stars&q=WFGY) |
...
| **xlxwalex** | FGCEC (118★), HyCxG (19★), ABSA-Scope (5★) · NLP & Computational Linguistics researcher (Zhejiang University) | ![](./images/xlxwalex_star.png) | [proof](https://github.com/xlxwalex?tab=stars&q=WFGY) |
